...
// 继承了父类的处理@PostConstruct和@PreDestroy注解逻辑
// 在父类基础上处理@Resource、@PostConstruct、@PreDestroy的逻辑
// 处理方式：
...
// （3）在InstantiationAwareBeanPostProcessor实现的属性装载的前置处理方法中，反射注入有@Resource等注解的bean
public class CommonAnnotationBeanPostProcessor extends InitDestroyAnnotationBeanPostProcessor
	...
	public CommonAnnotationBeanPostProcessor() {
		...
		// 设置两个生命周期注解@PostConstruct、@PreDestroy
	...
	// 属性装载的前置处理，在这里通过反射给bean注入@Resource、@EJB、@WebServiceRef注解的属性或者方法
	@Override
