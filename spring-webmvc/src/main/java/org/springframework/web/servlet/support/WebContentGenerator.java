...
public abstract class WebContentGenerator extends WebApplicationObjectSupport {
	 ...
	 */
	/**
	 * 设置响应头Vary，该响应头作用是决定某些请求头是用缓存的还是向服务器请求新的
	 ...
	 */
	/**
	 * 设置是否需要响应头Expires，该响应头作用是设置缓存过期时间，默认不需要
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 设置是否需要cache-control请求头，该请求头是缓存的核心，默认是需要
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 设置cache-control是否添加值：no-store，该值作用不存储客户端请求和响应的任何内容，默认true
	 *  如果设置为false将使用值：no-cache
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 设置cache-control是否添加值：must-revalidate，作用：缓存必须在使用之前验证旧资源的状态，并且不可使用过期资源。默认不设置
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 预处理响应，加入响应头cache-control以及Vary
	 * @param response
	 */
	...
	/**
	 * 获取响应头Vary的信息，如果response已经包含了Vary与varyByRequestHeaders合并
	 */
